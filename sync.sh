...
## on remote, yarn build && sudo -u www-data php bin/console cache:clear
...
sudo /var/www/lib/sbin/fsync -c -d assets/* assets/**/* config/* config/**/* migrations/* migrations/*/** public/favicon/* \
 ...
 public/robots.txt public/sitemap.xml src/* src/**/* templates/**/* templates/* tests/* tests/**/* translations/* translations/**/* package.json sync.sh webpack.config.js composer.json composer.lock yarn.lock